...
See [documentation](https://hetida.github.io/hetida-designer/get_started/).

## Additional Information and Documentation

The [documentation](https://hetida.github.io/hetida-designer) covers everything from [design decisions](https://hetida.github.io/hetida-designer/design_decisions/), [concepts](https://hetida.github.io/hetida-designer/user_guide/tutorials/basic_concepts/) over [usage](https://hetida.github.io/hetida-designer/user_guide/tutorials/component_workflow_tutorial/), [integration](https://hetida.github.io/hetida-designer/integration_guide/api/) and [deployment / operation](https://hetida.github.io/hetida-designer/deployment_operation/authentication/) up to [development](https://hetida.github.io/hetida-designer/development/development-setup/).

Please make sure to read the [security hints](https://hetida.github.io/hetida-designer/deployment_operation/security_hints/) for using hetida designer.
