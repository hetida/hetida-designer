...
export class BaseItemActionService {
    ...
    public editDetails(baseItem: BaseItem): void {
        ...
        >(CopyBaseItemDialogComponent, {
            width: '640px',
            data: {
                title: `Edit ${baseItem.type.toLowerCase()} ${baseItem.name} ${baseItem.tag
                    }`,
                content: '',
    ...
    public delete(abstractBaseItem: AbstractBaseItem): Observable<boolean> {
        ...
        >(ConfirmDialogComponent, {
            width: '640px',
            data: {
                title: `Delete ${abstractBaseItem.type.toLowerCase()} ${abstractBaseItem.name
    ...
    public deprecate(abstractBaseItem: AbstractBaseItem) {
        ...
        >(ConfirmDialogComponent, {
            width: '640px',
            data: {
                title: `Deprecate ${abstractBaseItem.type.toLowerCase()} ${abstractBaseItem.name
                    } (${abstractBaseItem.tag})`,
