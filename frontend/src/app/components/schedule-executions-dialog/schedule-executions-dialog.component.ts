...
import { ScheduledJobState } from 'src/app/enums/scheduled-Job-state';
...
export interface ScheduleExecution {
  ...
  exec_result: ExecutionResponse | undefined;
}
...
export class ScheduleExecutionsDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._loadExecutions();
  }

  _getDuration(execution: ScheduleExecution): string {
  ...
  _getTrafoName(name: string): string {
  ...
  _onShowExecResult(execution: ScheduleExecution): void {
  ...
  _onShowExecInput(execution: ScheduleExecution): void {
