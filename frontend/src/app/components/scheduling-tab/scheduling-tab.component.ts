...
import { tap, finalize, switchMap, first, map, takeUntil } from 'rxjs/operators';
            ...
            .subscribe(results => {
                results.forEach(({ schedule, transformation, index }) => {
                    if (transformation) {
                        ...
                        this.schedules[index].transformation_version_tag = transformation.version_tag;
                        ...
                        this.schedules[index].active = false;
                    }
                    // TODO: put changes to Schedule API
                });
            });
    }
