...
class KafkaMessageValueRepresentation(BaseModel):
    ...
    @classmethod
    def parse_value_correctly(cls, value: Any, info: ValidationInfo) -> Any:
    ...
    def serialize_value(self, value: Any) -> Any:
        ...
        return serializer_funcs_by_type.get(
            data_type_map[external_type_to_datatype[external_type]], lambda x: x
        )(value)
