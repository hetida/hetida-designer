...
from hetdesrun.exportimport.importing import import_transformation_from_dir
...
def delete_all_and_refill(directly_in_db: bool = False) -> None:
    ...
    import_transformation_from_dir("./transformations", directly_into_db=directly_in_db)
