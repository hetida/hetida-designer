"""Documentation for Highpass Filter

# Highpass Filter

## Description
Butterworth high-pass filter for uniformly sampled time series (exactly constant spacing) with zero-phase option.
...
COMPONENT_INFO = {
    "inputs": {
        ...
        "cutoff_frequency": {"data_type": "FLOAT"},
        "frequency_as_periods_per_unit": {"data_type": "STRING", "default_value": "s"},
    ...
    "version_tag": "1.0.1",
    "id": "dd49e8eb-b4fe-4786-ad29-faf3c88d84e6",
    "revision_group_id": "ea7b4c4d-8d1e-4dc3-8234-c4de128b52cc",
    "state": "RELEASED",
    "released_timestamp": "2025-05-13T08:11:21.059223+00:00",
}
...
def main(
    *,
    ...
    if frequency_as_periods_per_unit not in {"s", "m", "h", "d"}:
        raise ComponentInputValidationException(
            'Only "s", "m", "h", or "d" are valid inputs for frequency_as_periods_per_unit.',
            invalid_component_inputs=["frequency_as_periods_per_unit"],
        )

    if frequency_as_periods_per_unit == "m":
        cutoff_frequency *= 1 / 60
    if frequency_as_periods_per_unit == "h":
        cutoff_frequency *= 1 / (60 * 60)
    ...
    b, a = butter(order, normal_frequency, btype="high", analog=False)
...
TEST_WIRING_FROM_PY_FILE_IMPORT = {
    "input_wirings": [
        ...
        {"workflow_input_name": "cutoff_frequency", "filters": {"value": "0.25"}},
        {
            "workflow_input_name": "frequency_as_periods_per_unit",
        ...
        {
            "workflow_input_name": "forward_backward",
            "use_default_value": True,
            "filters": {"value": "true"},
        },
    ]
