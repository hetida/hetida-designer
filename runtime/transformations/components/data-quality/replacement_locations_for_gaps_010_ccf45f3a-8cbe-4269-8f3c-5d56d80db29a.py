...
- **interval_start_timestamp** (String, default value: null):
  ...
  that will be used if no **interval_start_timestamp** is provided.
...
- **interval_end_timestamp** (String, default value: null):
  ...
  that will be used if no **interval_end_timestamp** is provided.
...
class GapDetectionParameters(BaseModel, arbitrary_types_allowed=True):
    ...
    gap_intervals: pd.DataFrame | None
...
COMPONENT_INFO = {
    "inputs": {
        ...
        "auto_freq_percentile": {"data_type": "FLOAT", "default_value": None},
...
def main(
    *,
    ...
    auto_freq_percentile=None,
    auto_freq_min_amount_datapoints=11,
    expected_data_frequency=None,
    expected_data_freq_allowed_variance_factor=None,
    ...
    return {"replacement_locations": None}
