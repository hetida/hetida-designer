"""Documentation for Reset Index and Save as Column
...
## Details
Resets the index of the df_to_reset_index and saves it as a new column with the name index_name.

The index_name is expected not to occur in the columns of the df_to_reset_index. If it does, a ComponentInputValidationException is raised.
...
COMPONENT_INFO = {
    ...
    "version_tag": "1.0.0",
    "id": "77258f6a-db49-42a6-8133-7fcfd5bffddb",
    "revision_group_id": "175f432d-0efd-499c-bf62-85aa42761de9",
    "state": "RELEASED",
    "released_timestamp": "2024-12-03T15:49:27.058488+00:00",
}

from hdutils import parse_default_value  # noqa: E402, F401


def main(*, df_to_reset_index, index_name="timestamp"):
    # entrypoint function for this component
    # ***** DO NOT EDIT LINES ABOVE *****

    # check whether index_column is in the columns and is appropriate as the index of a dataframe
    if index_name in df_to_reset_index.columns:
        raise ComponentInputValidationException(
            f"There is already a column named {index_name} in the DataFrame passed to df_to_reset_index.",
            invalid_component_inputs=["df_to_reset_index", "index_name"],
        )

    reset_df = df_to_reset_index.reset_index(drop=False, names=index_name, allow_duplicates=False)
