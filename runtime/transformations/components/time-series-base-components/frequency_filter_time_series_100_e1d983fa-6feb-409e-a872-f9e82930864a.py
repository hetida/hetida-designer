...
COMPONENT_INFO = {
    ...
    "description": "Apply a lowpass or highpass frequency filter to a uniformly sampled time series.",
    "version_tag": "1.0.0",
...
def main(
    *,
    timeseries,
    filter_type=parse_default_value(COMPONENT_INFO, "filter_type"),
    cutoff_period=parse_default_value(COMPONENT_INFO, "cutoff_period"),
    order=parse_default_value(COMPONENT_INFO, "order"),
    forward_backward=parse_default_value(COMPONENT_INFO, "forward_backward"),
):
