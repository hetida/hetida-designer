...
def test_engine_url_logic_with_auth(caplog):
    # Enable auth explicitly within the test instead of relying on a broader-scoped
    # fixture, so the test is independent of the surrounding runtime_config.auth state.
    with (
        ...
        with mock.patch(  # noqa: SIM117
            ...
            RoleToRuntimeEngineUrlMapping({"privileged_hd_user": "test_privileged_runtime_url"}),
        ):
        ...
        with mock.patch(  # noqa: SIM117
            ...
            # should fallback to the default engine url
