...
To explore these concepts in greater depth read [basic concepts](./user_guide/tutorials/basic_concepts.md) and [versioning and lifecycle](./user_guide/versioning_and_lifecycle.md).
