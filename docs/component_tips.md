...
But: you can change the `def main` to `async def main`. This is recommended for component adapter components that are io bound and use an async library to fetch / send data.
