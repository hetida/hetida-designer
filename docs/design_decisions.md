...
The rationale for the described design decisions assumes familiarity with the [basic concepts](./user_guide/tutorials/basic_concepts.md).
...
- _Varying Dependencies:_ Different [Runtime Variants](./deployment_operation/varying_runtime_services.md) can provide different dependency sets when needed, offering flexibility without compromising the stability of any given runtime.
