...
We will demonstrate workflow execution via Kafka using one of the example workflows provided with the [base component/workflow deployment](../base_component_deployment.md).
