...
You need to implement all those endpoints of the [Adapter API specification](../adapter_rest_api_interface.md) that are necessary for the user interface to work. These endpoints will be used to construct wirings which your runtime plugin then receives.
