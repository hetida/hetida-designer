...
This built-in adapter is an example of a [general custom adapter](../custom_adapters/general_custom_adapter.md).
...
![](../../../assets/local_file_adapter_selected.png){ width=277}
<figcaption>Selecting a file using the local file adaper</figcaption>
</figure>

<figure markdown="span">
![](../../../assets/browsing_local_file_adapter.png){ width=500 }
</figure>
