...
* The fact that execution of each trafo revision is immediately available through a [web service endpoint](./execution_via_api.md) or via [Kafka](./execution_via_kafka.md) – there is **no extra deployment step necessary**.
