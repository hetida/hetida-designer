...
The API is documented via the [openapi.json](https://github.com/hetida/hetida-designer/blob/release/runtime/openapi.json) file. We recommend to display it with an appropriate openapi viewer application.
