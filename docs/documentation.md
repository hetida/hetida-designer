...
The most relevant information about hetida designer is collected in the readme file.

- [Readme](../README.md)

Further information about developing, deploying, connecting, using and running hetida designer can be found in the files linked below.

## Developing hetida designer

- [Contributing](../CONTRIBUTING.md)
- [Changelog](../CHANGELOG.md)
- [Frontend Coding Standards](../frontend/CODING_STANDARDS.md)
- [Runtime and Backend Coding Standards](../runtime/CODING_STANDARDS.md)
